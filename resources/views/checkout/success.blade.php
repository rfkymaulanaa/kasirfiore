...
<x-app-layout>
    <section class="p-3 sm:p-5 flex justify-center">
        <div id="struk-belanja" class="bg-white p-6 rounded-lg shadow-md w-full max-w-lg border border-gray-300">
            <h1 class="text-xl text-center font-bold">Buket Fiore</h1>
            <p class="text-sm text-center text-gray-700">Jl. Handil Bakti No. 123, Banjarmasin</p>
