                    ...
                    <div class="flex justify-between">
                        <form action="{{ route('produk.search') }}" method="get">
                            ...
                            <div class="relative w-full">
                                ...
                                <input type="text" id="search" name="search" class="block p-2 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Search" value="{{ request('search') }}">
                            </div>
                        </form>
                    </div>
                        ...
                        <tbody>
                            @forelse ($produk as $item)
                                <tr
                                    ...
                                    <td scope="row" class="px-6 py-4">Rp.
                                    ...
                                    <td scope="row" class=" flex items-center justify-end">
                                        <form action="{{ route('produk.destroy', $item) }}" method="post" class="flex items-center gap-2">
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                                ...
                                                <a href="{{ route('produk.show', $item) }}" class="hover:underline">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                                ...
                                                <button onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')" type="submit" class="flex">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
