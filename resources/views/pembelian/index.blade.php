<x-app-layout>
    ...
    <section class="p-3 sm:p-5">
        <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
           ...
           {{-- Mengurutkan --}}
            <div class=" relative z-20 mb-6 flex items-center justify-between bg-white backdrop-blur-sm rounded-xl p-4 shadow-lg ">
            ...
            @forelse ($produk as $item)
                <div class="rounded-lg border border-gray-200 bg-white p-4 shadow-sm flex flex-col">
                    ...
                    <div class="pt-4 flex flex-col flex-1">
                        ...
                        <div class="mt-auto p-4 flex items-center justify-between">
                            <p class="text-md font-extrabold text-gray-900">Rp.{{number_format($item->harga, 2, ',', '.') }}</p>
                ...
                @empty
                <h3 class=" text-black-900">Produk Tidak Tersedia</h3>
            @endforelse
