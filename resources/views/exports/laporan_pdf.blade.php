...
<body>
    <div class="header-laporan">
        <p style="font-size: x-large; font-weight: 600;">Bucket Fiore</p>
        <p style="font-size: 12px;">Jl. Handil Bakti No. 123, Banjarmasin</p>
        <p style="font-size: 12px;">Telepon: 088705006938 </p>
    </div>
    <hr>
